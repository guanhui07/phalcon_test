...
//\Phalcon\Mvc\Controller  ControllerBase
...
//        print_r($robots);die;
    ...
    { //error
        ...
        //sql
        $rs = $this->db->fetchAll('select * from users', \Phalcon\Db::FETCH_ASSOC);
...
//        echo "Total Elapsed Time: ", $profile->getTotalElapsedSeconds(), "\n";
    ...
    public function ttdbAction(){
        $model = Accounts::instance();
        $result = $model->add($data);

        $account = $model->findFirst($id);
