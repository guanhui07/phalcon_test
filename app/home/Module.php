...
class Module implements ModuleDefinitionInterface
{
    ...
    public function registerServices(\Phalcon\DiInterface $di)
    {
        ...
        $di->set('view', function () use ($di) {
            ...
            if (isset($config->views->path->home)) {
                $view->setViewsDir($config->views->path->home);
            } else {
                $theme = isset($config->views->theme->home) ? $config->views->theme->home : 'default';
                ...
                ".volt"     => function ($view, $di) {
                    ...
                    $volt->setOptions(array(
                        'compiledPath' => function ($template_path) {
                            ...
                            $template_cache =  APP_PATH . '/runtime/cache/volt/home' . dirname($template_path);
